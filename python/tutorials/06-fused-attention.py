...
def _fwd_kernel(
    ...
    for start_n in range(0, (start_m + 1)*BLOCK_M, BLOCK_N):
        ...
        # initialize qk with relative extent if required
...
@pytest.mark.parametrize('Z, H, N_CTX, D_HEAD, EXTENT', [(3, 2, 2048, 64, 256)])
def test_op(Z, H, N_CTX, D_HEAD, EXTENT, dtype=torch.float16):
